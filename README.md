# CSS Custom Function Function Polyfill and PostCSS plugin
...
A modern JavaScript polyfill and PostCSS plugin for the [CSS Custom Functions](https://drafts.csswg.org/css-mixins-1/) with **hybrid build-time and runtime processing**. Transforms CSS Custom Functionss to native `@media` and `@supports` rules where possible, with runtime fallback for dynamic conditions.
